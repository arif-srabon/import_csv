...
function previewImage(input, showTarget) {
...
$(function() {
    ...
    /**
     * toggleText() : new jQuery function
     * @author  Diego Favero
     * @link    http://stackoverflow.com/a/26183153/1743124
     * ...
     */
    jQuery.fn.extend({
    ...
    $('.sidebar-main-toggle').on('click', function (e) {
        ...
        // Toggle icon and icon text
        $('#sidebar-toggle-icon').toggleClass( 'icon-circle-right2 icon-circle-left2' );
        var label = $(this).find('.collapse-label');
        label.toggleText( 'Expand Menu', 'Collapse Menu' );
    });
...
$(document).ready(function(){
    $('#sidebar-theme-switcher .btn').on('click', function(){
        var radio_val = $(this).find('input[type="radio"]');
        if( radio_val.val() === 'default' ) {
            window.location.replace('/setColor/default');
            //console.log('default');
        }
        else if( radio_val.val() === 'green' ) {
            window.location.replace('/setColor/green');
            //console.log('green');
        }
        else {
            window.location.replace('/setColor/violet');
            //console.log('violet');
        }
