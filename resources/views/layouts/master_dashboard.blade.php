...
<head>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/core/libraries/morris.min.js')}}"></script>
    <!-- /core JS files -->
            ...
            <div class="page-header">
                ...
                <div class="breadcrumb-line">
                    ...
                    <ul class="breadcrumb-elements">
                        <li>
                            <?php $session = Session::get("sess_office_jurisdiction"); ?>
                            @if (count($session) > 0)
                                @if (SentinelAuth::check('dss.transactions.beneficiary.add'))
                                    <a href="{{url('beneficiary')}}">
                                        <button class="btn btn-info btn-labeled btn-xs">
                                            <b><i class="icon-add"></i></b> {{trans('master.btn_beneficiary')}}
                                        </button>
                                    </a>
                                @endif
                            @endif
                        ...
                        <li>
                            <a href="{{url('dashboard_full')}}">
                                <button class="btn btn-info btn-labeled btn-xs">
                                    <b><i class="icon-home"></i></b>{{trans('master.btn_dashboard')}}
                                </button>
                            </a>
                        </li>
                        @endif
                        <li>
                            <a href="{{url('beneficiarysummary')}}">
                                <button class="btn btn-info btn-labeled btn-xs">
                                    <b><i class="icon-chart"></i></b>{{trans('master.btn_report')}}
                                </button>
                            </a>
                        </li>
                    </ul>
