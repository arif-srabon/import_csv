    ...
    <section id="breadcrumbs">
        <div class="container-fluid content-wrapper">
            <ol class="breadcrumb">
                ...
                <li>{{ trans('web/counterfeit.breadcrumb_complaints') }}</li>
                <li class="active">{{ trans('web/counterfeit.page_title') }}</li>
            </ol>
        </div>
        ...
        <div class="container-fluid content-wrapper">
            ...
            <article>
                ...
                <div class="entry-content page-content">
                    ...
                    {!! Form::open(['url' => 'complaints/counterfeit', 'method' => 'post', 'id' =>'form-counterfeit', 'name'=>'form_counterfeit']) !!}
