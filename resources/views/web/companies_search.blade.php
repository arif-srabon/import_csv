    ...
    <section id="breadcrumbs">
        <div class="container-fluid content-wrapper">
            <ol class="breadcrumb">
                ...
                <li class="active">{{ trans('web/companies.search_title') }} <em class="text-muted">{{ Input::get('search') }}</em></li>
            </ol>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <h3 class="entry-title page-title">
                            {{ trans('web/companies.search_title') }} <em class="text-muted">{{ Input::get('search') }}</em>
                        </h3>
                    </div>
                    <div class="col-sm-3">
            ...
            <div class="entry-content page-content">
                ...
                <?php } else { ?>
                    ...
                    <div class="alert alert-danger" role="alert">
                        <p><i class="fa fa-exclamation-circle"></i> {{ trans('web/companies.no_data_found') }}</p>
                    </div>
