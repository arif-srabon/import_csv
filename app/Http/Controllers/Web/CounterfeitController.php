...
class CounterfeitController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.counterfeit', compact('district'))->with($data);
    }
    ...
    public function store(CounterfeitRequest $request)
    {
        ...
        try
        {
            ...
            return redirect('complaints/counterfeit/create')->with('successMsg', config('app_config.msg_save'));

        } catch (\Exception $e) {

            return redirect('complaints/counterfeit/create')
