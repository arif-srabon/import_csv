...
class ADRControllerMobile extends Controller
{
    public $lang;
    ...
    public function index()
    {
        ...
        return view('web.adr_mobile', compact('district'))->with($data);
    }
    ...
    public function store(Request $request)
    {
        ...
        try
        {
            ...
            return redirect('complaints/adr-mobile/create')->with('successMsg', config('app_config.msg_save'));

        } catch (\Exception $e) {

            return redirect('complaints/adr-mobile/create')->with('dangerMsg', $e->getMessage());
